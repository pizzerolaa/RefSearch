...
//             parsedArticle.title = latexToUnicode(parsedArticle.title);
//             parsedArticle.authors = parsedArticle.authors.map(latexToUnicode);
...
//                 <h1>{article.title}</h1>
//                 <h2>{article.authors.join(', ') || 'Unknown Author'}</h2>
//                 <h2>{article.year || 'Not available'}</h2>
